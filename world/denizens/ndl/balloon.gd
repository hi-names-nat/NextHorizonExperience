...
@export var viewpoint_cam: Camera3D = null

## The dialogue resource
var resource: DialogueResource

# The node to render on top of
...
var waiting_for_reponse: bool = false
...
@onready var world_message: Control = %WorldDialogueLine
...
func _process(_delta) -> void:
	if display_node == null: return
		...
		world_message.visible = not viewpoint_cam.is_position_behind(display_node.global_transform.origin)
		# multiply by 4 to transform it over 
		world_message.position = viewpoint_cam.unproject_position(display_node.global_transform.origin) * 4
